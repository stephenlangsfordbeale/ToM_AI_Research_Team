...
class ToMPolicy(nn.Module):
    ...
    def uses_explicit_repair_mask(self) -> bool:
        return self.tom_experiment == "rebus_reflective_hybrid_explicit_mask"
...
def rollout_episode(
    ...
    while not done:
        ...
        if isinstance(model, ToMPolicy) and model.uses_reflective_rebus():
            ...
            state = model.update_reflective_state(state, surprise_t, repair_t)
...
def analyze_choice_context_outcomes(
    ...
    for scenario in scenarios:
        ...
        while not done:
            ...
            if isinstance(model, ToMPolicy) and model.uses_reflective_rebus():
                state = model.update_reflective_state_numpy(state, outcome_surprise, repair_surprise)
